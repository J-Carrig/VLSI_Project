...
initial
    begin
        ...
        i = 0;
  		  ...
  		  input_b_stb = 1'b1;
  		  output_z_ack = 1'b1;
        $readmemh("mult_stim_a.txt" , array_a ); // initialize memory a
        $readmemh("mult_stim_b.txt" , array_b );// initialize memory b
		  $readmemh("mult_output.txt" , array_out );// Initialize output memory
        Tin_a = 64'h0;
        Tin_b = 64'h0;
        #10 rst = ~rst;
        #10 rst = ~rst;
...
//Instantiation
double_multiplier uut(.input_a(input_a),
                 .input_b(input_b),
