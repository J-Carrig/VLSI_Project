...
Input_3a = [2; 2; 2; -2; 2; 0; -0; inf; inf; -inf; -inf; inf; inf; inf; NaN; NaN; -NaN; -NaN; NaN; NaN; NaN];
Input_3b = [0.7; 0; -0; 2; -2; -2; +2; inf; -inf; -inf; +inf; 2; -2; 0; NaN; -NaN; -NaN; +NaN; 2; -2; 0];
...
fid = fopen('mult_stim_a.txt', 'wt');
fid2 = fopen('mult_stim_b.txt', 'wt');
fid3= fopen('mult_output.txt', 'wt');
